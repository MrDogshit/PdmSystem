...
def SearchHome(request):
    ...
    voltage_min = request.POST.get('voltage_min', 0)
    voltage_max = request.POST.get('voltage_max')
    height_min = request.POST.get('height_min', 0)
    height_max = request.POST.get('height_max')
    producter = request.POST.get('producter')
    value_min = request.POST.get('value_min', 0)
    value_max = request.POST.get('value_max', 0)
    tol_min = request.POST.get('tol_min', 0)
